    ...
    <body>
        ...
        <script>
            ...
            async function updatePrompt() {
                ...
                console.log("Updating prompt for:", title, "Level:", currentLevel);
                ...
                try {
                    ...
                    console.log("Prompt successfully updated!");
                    
                } catch (err) {
                    console.error("Failed to update prompt:", err);
                    document.getElementById('promptDisplay').innerText = "에러 발생: " + err.message;
                }
            }
